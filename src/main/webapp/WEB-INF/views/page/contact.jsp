...
<body>
   ...
   <!-- Navigation -->
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <form name="sentMessage" id="contactForm" novalidate>
                    ...
                    <button type="submit" class="btn contactb">Send Message</button>
                </form>
            </div>
    ...
    <!-- /.container -->
       ...
       <!-- jQuery -->
    <script src="<c:url value="/resources/page/js/jquery.js"/>"></script>

    <!-- Bootstrap Core JavaScript -->
    <script  src="<c:url value="/resources/page/js/bootstrap.min.js"/>"></script>
